...
// LightsA 4 corners stucked ON
LightsA[0][0]               = 1;
LightsA[0][maxDim-1]        = 1;
LightsA[maxDim-1][0]        = 1;
LightsA[maxDim-1][maxDim-1] = 1;
...
for ( var k = 0; k < maxSteps; k++ )
{
    ...
    // LightsZ 4 corners stucked ON
    LightsZ[0][0]               = 1;
    LightsZ[0][maxDim-1]        = 1;
    LightsZ[maxDim-1][0]        = 1;
    LightsZ[maxDim-1][maxDim-1] = 1;
